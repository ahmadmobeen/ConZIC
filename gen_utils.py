...
import random
from baselines.ConZIC.utils import get_init_text, update_token_mask, write_csv
import time
...
def generate_caption(img_name, model, clip, tokenizer,image_instance,token_mask,logger,
    ...
    for i in range(batch_size):
        ...
        write_csv(img_name[i], best_caption[i], best_clip_score[i], 'results/ConZIC/thumbnails.csv')
